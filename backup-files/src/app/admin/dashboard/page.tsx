                ...
                {streamers.map((streamer) => (
                  <Card key={streamer._id} className="w-full">
                    ...
                    <div>
                      ...
                      <div className="mt-4">
                        <Label htmlFor={`image-${streamer._id}`}>프로필 이미지 업로드</Label>
                        <div className="flex gap-2 mt-1">
                          <Input
                            id={`image-${streamer._id}`}
                            type="file"
                            accept="image/*"
                            onChange={async (e) => {
                              ...
                              formData.append('streamerId', streamer._id)
                    ...
                    <CardContent>
                      ...
                      <div>
                        <p className="text-sm font-medium mb-2">소개</p>
