        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <h2 className="text-4xl font-bold mb-4 flex items-center gap-2">
                <span className="text-primary">CORE</span> MISSION
              </h2>
              <p className="text-muted-foreground text-lg leading-relaxed">
                The mission at TENET is simple - we foster a thriving trading community through high quality educational 
                resources and a supportive network. Led by our expert traders, we provide valuable insights and real-time 
                market updates to help traders navigate the cryptocurrency markets confidently. Statistics reveal that 
                without such resources, a majority of new traders struggle significantly. Our goal is to flip this narrative, 
                offering the tools and environment necessary for sustainable trading achievements.
              </p>
                  </div>
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="bg-background/50 backdrop-blur-sm border-none shadow-lg">
                <CardHeader>
                  <CardTitle className="text-lg">A hard truth about trading</CardTitle>
                  <div className="mt-4">
                    <span className="text-6xl font-bold text-primary">94%</span>
                    <p className="mt-4 text-sm text-muted-foreground">
                      A vast majority of individuals who start trading without proper education and community support 
                      end up losing their entire investment within just six months
                    </p>
                  </div>
                </CardHeader>
              </Card>
              <Card className="bg-background/50 backdrop-blur-sm border-none shadow-lg">
                <CardHeader>
                  <CardTitle className="text-lg">Consistency via collaboration</CardTitle>
                  <div className="mt-4">
                    <span className="text-6xl font-bold text-primary">71%</span>
                    <p className="mt-4 text-sm text-muted-foreground">
                      Traders who engage in continuous learning and leverage community activities are significantly 
                      more likely to achieve consistent results over time
                    </p>
                  </div>
                </CardHeader>
              </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-xl text-muted-foreground">Professional Traders</p>
            </div>
            <div className="text-center">
              <h3 className="text-6xl font-bold mb-4 bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                24/7
              </h3>
              <p className="text-xl text-muted-foreground">Live Analysis</p>
            </div>
            <div className="text-center">
              <h3 className="text-6xl font-bold mb-4 bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                100K+
              </h3>
              <p className="text-xl text-muted-foreground">Community Members</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-background/50 backdrop-blur-sm border-none shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Get real-time market insights from professional traders with proven track records in both bull and bear markets.
                </CardDescription>
              </CardHeader>
            </Card>
            <Card className="bg-background/50 backdrop-blur-sm border-none shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Watch live trading sessions and learn strategies directly from experienced traders as they navigate the markets.
                </CardDescription>
              </CardHeader>
            </Card>
            <Card className="bg-background/50 backdrop-blur-sm border-none shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Join a vibrant community of traders, share insights, and learn from both experts and peers in real-time.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
